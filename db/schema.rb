...
ActiveRecord::Schema.define(version: 20_190_427_014_051) do
  ...
  create_table 'courses', id: :serial, force: :cascade do |t|
    ...
    t.string 'initial'
    t.index %w[name initial], name: 'index_courses_on_name_and_initial'
  end
  ...
  create_table 'sectors', id: :serial, force: :cascade do |t|
    ...
    t.string 'slug'
    t.string 'icon'
    t.index %w[name initial slug], name: 'index_sectors_on_name_and_initial_and_slug'
  end
