class AddProhibitionsAndResponsibilities < SeedMigration::Migration
  def up
    ProhibitionAndResponsibility.create!([
      ...
      {item: 'V- Assistiràsaulassemaefetivaçãodamatrícula'},
      ...
      {item: 'VII- AlteraroudeturparoteordedocumentosoficiaisdoIFMS'},
      {item: 'VIII- UsaralogomarcadoIFMSdeformaindevidaounãoautorizada'},
      ...
      {item: 'XII- Praticarjogosdeazarouatosquerevelemfaltadeidoneidade'},
      ...
      {item: 'XVI- Exerceratividadespolítico-partidáriasnoâmbitodoIFMS'},
